...
class CompanyStaff(models.Model):
    ...
    staff_kyc_driving_licence = modemaster_property_document_typels.ImageField(verbose_name="Staff KYC Driving Licence", upload_to=gv.IMAGE_REPO_FOLDER, null=True, blank=True)
